import { Stack, alpha, Avatar, Dialog, IconButton, Typography, DialogContent } from '@mui/material';
...
export default function ChatRoomParticipantDialog({ onClose, open, participant }: Props) {
  return (
